      ...
      return function(t) {
        ...
        var r = n(100), i = n(1), o = n(39), s = n(14), u = n(10), a = n(28), l = i([].push), c = function(t2) {
          ...
          return function(d, v, g, y) {
            for (var b, m, x = s(d), _ = o(x), O = r(v, g), w = u(_), S = 0, E = y || a, L = e2 ? E(d, w) : n2 || p ? E(d, 0) : void 0; w > S; S++)
        ...
        (x || O || _ || f || p) && (v = function(t2) {
          var e2, n2, i2, u2, a2, f2, p2, w = this, S = c(w), E = o(t2), L = S.raw;
          if (L)
            return L.lastIndex = w.lastIndex, e2 = r(v, L, E), w.lastIndex = L.lastIndex, e2;
          var k = S.groups, P = _ && w.sticky, j = r(s, w), T = w.source, A = 0, V = E;
          if (P && (j = b(j, "y", ""), -1 === y(j, "g") && (j += "g"), V = m(E, w.lastIndex), w.lastIndex > 0 && (!w.multiline || w.multiline && "\n" !== g(E, w.lastIndex - 1)) && (T = "(?: " + T + ")", V = " " + V, A++), n2 = new RegExp("^(?:" + T + ")", j)), O && (n2 = new RegExp("^" + T + "$(?!\\s)", j)), x && (i2 = w.lastIndex), u2 = r(d, P ? n2 : w, V), P ? u2 ? (u2.input = m(u2.input, A), u2[0] = m(u2[0], A), u2.index = w.lastIndex, w.lastIndex += u2[0].length) : w.lastIndex = 0 : x && u2 && (w.lastIndex = w.global ? u2.index + u2[0].length : i2), O && u2 && u2.length > 1 && r(h, u2[0], n2, function() {
            for (a2 = 1; a2 < arguments.length - 2; a2++)
              void 0 === arguments[a2] && (u2[a2] = void 0);
          }), u2 && k)
            for (u2.groups = f2 = l(null), a2 = 0; a2 < k.length; a2++)
              p2 = k[a2], f2[p2[0]] = u2[p2[1]];
          return u2;
        }), t.exports = v;
      }, function(t, e, n) {
        ...
        if (s("Number", !m(" 0o1") || !m("0b1") || m("+0x1"))) {
          for (var L, k = function(t2) {
            ...
            a(m, L = P[j]) && !a(k, L) && g(k, L, v(m, L));
          k.prototype = x, x.constructor = k, u(i, "Number", k, { constructor: true });
        }
      }, function(t, e, n) {
        "use strict";
        var r = n(3), i = n(45);
        ...
        var c = n(88), f = n(87), p = n(129), h = (n.n(p), n(82)), d = (n.n(h), n(81)), v = (n.n(d), n(83)), g = (n.n(v), n(84)), y = (n.n(g), n(128)), b = (n.n(y), n(135)), m = (n.n(b), n(127)), x = (n.n(m), n(132)), _ = (n.n(x), n(131)), O = (n.n(_), n(125)), w = (n.n(O), n(130)), S = (n.n(w), n(52)), E = (n.n(S), n(53)), L = (n.n(E), n(85)), k = (n.n(L), n(134)), P = (n.n(k), n(80)), j = (n.n(P), n(79)), T = (n.n(j), n(133)), A = (n.n(T), n(126)), V = (n.n(A), function() {
        ...
        e.a = { data: function() {
          ...
          return V(l(e2, n2, this.groupValues, this.groupLabel, this.customLabel), a(this.groupValues, this.groupLabel))(t2);
        }, flatAndStrip: function(t2) {
          return V(a(this.groupValues, this.groupLabel), u)(t2);
          ...
          if (n2) {
            if (this.wholeGroupSelected(n2)) {
              ...
              var r2 = this.internalValue.filter(function(t3) {
                return -1 === n2[e2.groupValues].indexOf(t3);
              });
              this.$emit("input", r2, this.id);
            } else {
              var i2 = n2[this.groupValues].filter(function(t3) {
                return !(e2.isOptionDisabled(t3) || e2.isSelected(t3));
              });
              this.max && i2.splice(this.max - this.internalValue.length), this.$emit("select", i2, this.id), this.$emit("input", this.internalValue.concat(i2), this.id);
            }
            this.closeOnSelect && this.deactivate();
          }
          ...
          this.isOpen && (this.isOpen = false, this.searchable ? void 0 !== this.$refs.search && this.$refs.search.blur() : void 0 !== this.$el && this.$el.blur(), this.preserveSearch || (this.search = ""), this.$emit("close", this.getValue(), this.id));
        }, toggle: function() {
